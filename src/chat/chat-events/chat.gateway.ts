    ...
    implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect
{
            ...
            this.chatService
                ...
                .subscribe((message: MessageDTO) => {
                    ...
                    this.chatService
                        ...
                        .pipe(take(1))
                        .subscribe(
                            (activeConversations: ActiveConversationDTO[]) => {
    ...
    deleteMessage(client: Socket, messageId: number): Subscription {
        this.chatService.deleteMessage(messageId).pipe(take(1)).subscribe()
    ...
    leaveConversation(client: Socket) {
        this.chatService.leaveConversation(client.id).pipe(take(1)).subscribe()
    }
