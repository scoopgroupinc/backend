...
import { UserVisualsService } from './user-visuals/user-visuals.service'
...
export class UserProfileService {
    ...
    async getFullProfile(userId: string): Promise<UserProfile> {
        ...
        //     // TODO: add images
        //     //const visuals = await this.userVisualsService.getVisualsByUserId(userId)

        //     // Subscribe to the observable to get the array of UserVisuals
